...
- ✅ ~~同步失败 "用户未注册"~~ — 已在 commit e849a7e 修复 (sync.js 自动注册)
- 所有已知问题已解决 🎉
...
| 日期 | 内容 | 状态 |
|------|------|:--:|
| 07-27 | 📥 **CSV 导出模块**: export-csv.js — 情绪/症状/量表/服药 4种CSV + 知情同意CSV | ✅ |
| 07-27 | 📦 **一键导出全部**: JSZip 打包 (4 CSV + 数据字典 + 知情同意) 为 ZIP 下载 | ✅ |
...
### 2.8 本周概况 Mini-Charts (07-27)

| 日期 | 内容 | 状态 |
|------|------|:--:|
| 07-27 | 📊 **Sparkline 渲染器**: 轻量 Canvas sparkline (line + bar), DPI 自适应 | ✅ |
| 07-27 | 😊 情绪趋势折线 sparkline: 最近7天, 颜色渐变填充 | ✅ |
| 07-27 | 🏥 症状柱状 sparkline: 每日症状分, 自动量程 | ✅ |
| 07-27 | 💊 本周服药依从率 + 状态标签 (良好/注意/偏低) | ✅ |
...
- [x] ~~生物学权重系数查阅文献验证~~ → 已完成 (Skubic 2025 + Robertson-Dixon 2023)
- [x] ~~症状权重 CGI-S 映射~~ → 已完成 (Busner 2007 + Leucht 2019 + Egger 2019)
- [ ] 单元测试覆盖
- [ ] 多语言支持
